...
@onready var moves_label = $HB/MC2/VB/HBLabel/MovesLabel
@onready var pairs_label = $HB/MC2/VB/HBLabel2/PairsLabel
...
func add_memory_tiles(ii_dict: Dictionary, frame_image: CompressedTexture2D) -> void:
...
func on_level_selected(level_num: int) -> void:
	...
	for ii_dict in level_selection.image_list:
		add_memory_tiles(ii_dict, frame_image)
		
	scorer.clear_new_gane(level_selection.target_pairs)
